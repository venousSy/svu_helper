...
export default function Sidebar() {
  ...
  return (
    <motion.aside 
      ...
      className="flex flex-col min-h-screen bg-surface/80 backdrop-blur-xl border-r border-border shrink-0 relative overflow-hidden"
    >
      <div className="absolute top-0 left-0 w-full h-64 bg-gradient-to-b from-brand-primary/5 to-transparent pointer-events-none" />

      <Link to="/" className="flex items-center gap-3 px-6 py-6 border-b border-border hover:bg-surface-elevated/50 transition-colors cursor-pointer group z-10 h-[85px]">
      ...
      <div className="p-4 border-t border-border z-10 flex items-center justify-between">
        <AnimatePresence>
          {!isCollapsed && (
            <motion.div 
              initial={{ opacity: 0 }} 
        ...
        <button
          ...
          className="p-1.5 text-text-muted hover:text-text-primary hover:bg-surface-elevated rounded-lg transition-colors ml-auto"
        >
